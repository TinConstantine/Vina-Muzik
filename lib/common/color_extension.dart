...
class TColor {
  ...
  static Color get textDrawer => const Color(0xffC1C0C0);
  static Color get floatingActionButtonColor => const Color(0xff23273B);
  static Color get contextMenu => const Color(0xff383849);
  static Color get dotColor => const Color(0xffFFB1B2);
  static Color get trackColor => const Color(0xffE9585A);
  static Color get progressBarColor => const Color(0xffFFB182);
}
